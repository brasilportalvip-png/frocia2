...
O décimo segundo bloco implementou o drill de recuperação somente leitura e o plano determinístico de navegador que converte os fluxos de cada especificação em gates obrigatórios. A execução operacional do drill e o CI da suíte ampliada continuam pendentes, conforme `recovery-drill-site-browser-plan-2026-08-30.md`.
